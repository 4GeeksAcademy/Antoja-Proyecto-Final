				...
				<div className="info-footer">
					<div className="information-contacts">
						<div className="info-icons">
							...
							<p className="text-footer">Avenida Apoquindo 3000, Las Condes, Santiago, Chile</p>
						</div>
						<div className="info-icons">
							<i className="fa-solid fa-phone"></i>
							<p className="text-footer">56 9 1111 2222 / 56 9 2222 3333</p>
						</div>
						<div className="info-icons">
							<i className="fa-solid fa-envelope"></i>
							<p className="text-footer">contacto@antojapizzeria.cl</p>
						</div>
					</div>
				</div>
				<div className="information-contacts">
